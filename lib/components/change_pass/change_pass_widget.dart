                    ...
                    child: Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'elmh6tns' /* Cambiar mi contraseña */,
                            ),
                        ...
                        FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent(
                                'CHANGE_PASS_arrow_back_sharp_ICN_ON_TAP');
                            logFirebaseEvent(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              '2w88daof' /* confirma el correo registrado ... */,
                            ),
                    ...
                    child: Row(
                      ...
                      children: [
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'CHANGE_PASS_COMP_ENVIAR_LINK_BTN_ON_TAP');
